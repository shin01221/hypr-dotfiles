...
local logins = {
            { '--addic7ed', 'mohamed0089', '01102706189Mm!' },
--          { '--legendastv', 'USERNAME', 'PASSWORD' },
            { '--opensubtitles', 'mohamed0089', '01102706189Mm!' },
...
function autosub_allowed()
    ...
    elseif active_format:find('^cue') then
       ...
       , 'flac', 'mp3', 'ogg', 'wav', 'wv    mp.msg.warn('This path is excluded from auto-downloading subs')
                return false
            end
        end
